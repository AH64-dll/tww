...
config.libs = [
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(Equivalent, "d/actor/d_a_grid.cpp"),  # framework-Equivalent (value-parity, 7-shape allocator)
            Object(NonMatching, "d/actor/d_a_himo2.cpp"),
            Object(Matching,    "d/actor/d_a_hookshot.cpp"),
            Object(Matching,    "d/actor/d_a_ib.cpp"),
            Object(Equivalent, "d/actor/d_a_item.cpp"),
    ...
    ActorRel(Equivalent,  "d_a_obj_ikada"), # weak func order,
    ...
    ActorRel(Equivalent, "d_a_bigelf"),  # regalloc/weak order
    ...
    ActorRel(MatchingFor("GZLJ01", "GZLE01", "GZLP01"),    "d_a_fallrock_tag"),  # D44J01 demo divergence (4B delta in Delete cDyl_Unlink)
    ...
    ActorRel(Equivalent, "d_a_mant"),  # regalloc: joint_control 96.87 (6 norm-diff ops = pure allocator residue) + daMant_Create 98.88 (1 mr scheduling); no structural diffs; weak order
    ...
    ActorRel(Equivalent, "d_a_npc_bmcon1"),
    ...
    ActorRel(Equivalent, "d_a_npc_gp1"),  # 21/21 accept-class 0-structural (+6 weak dtors = Equivalent basis)
    ...
    ActorRel(Equivalent, "d_a_npc_pm1"), # 7 sub-100 accept-class regalloc (RLead-20/R1-9/R5-9), weak-order class
    ActorRel(MatchingFor("GZLJ01", "GZLE01", "GZLP01"),    "d_a_npc_roten"),
    ActorRel(Matching,    "d_a_npc_rsh1"),
    ActorRel(Equivalent,  "d_a_npc_sarace"),
    ...
    ActorRel(Equivalent, "d_a_obj_hcbh"),
    ...
    ActorRel(Equivalent, "d_a_obj_mmrr"),  # regalloc/weak order
    ...
    ActorRel(Equivalent, "d_a_obj_try"),
    ...
    ActorRel(Equivalent, "d_a_warpls"),  # 44/47 @100, 3 accept-class holdouts; rel-link proves NOT Matching
    ActorRel(Equivalent, "d_a_warpmj"),  # regalloc/weak order

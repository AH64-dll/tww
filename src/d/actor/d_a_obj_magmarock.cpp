...
void daObjMagmarock::Act_c::demo_move() {
    /* Nonmatching */
    if (dComIfGs_isEventBit(0x380) || m29F != 0) {
        return;
    }
    if (m45A == 0) {
    ...
    BOOL daObjMagmarock::Act_c::CreateHeap() {
        ...
        return mpModel != NULL && brkInit != 0 && bckInit != 0;
    }
        ...
        if (m29F != 0) {
            ...
            if (mpLavaSmoke == NULL) {
                ...
                mpLavaSmoke = dComIfGp_particle_setToon(
                    dPa_name::ID_AK_SN_YOGANYUGE00, &current.pos, NULL, NULL, 153.0f + 102.0f * REG10_F(25),
                    NULL, -1, NULL, NULL, NULL);
                mpLavaBubble = dComIfGp_particle_setToon(
                    dPa_name::ID_AK_SN_YOGANYUGE01, &current.pos, NULL, NULL, 153.0f + 102.0f * REG10_F(26),
                    NULL, -1, NULL, NULL, NULL);

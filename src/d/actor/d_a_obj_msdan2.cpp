/**
 * d_a_obj_msdan2.cpp
 * Object - Tower of the Gods - Msdan2 (Message Dan 2; spawns MsdanSub2 sparks)
 */
...
cPhs_State daObjMsdan2::Act_c::Mthd_Create() {
    ...
    for (s32 i = 0; i < 16; i++) {
        ...
        fopAcM_create(fpcNm_Obj_MsdanSub2_e, prm_get_swSave() + (i << 8), &pos,
                      current.roomNo, &angle, NULL, -1, NULL);
    }
